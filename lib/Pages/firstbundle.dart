...
class First extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _First();
}

class _First extends ConsumerState<First> {
        ...
        body: SingleChildScrollView(
            child: Column(children: [
              Container(
                child: Row(
                  ...
                  children: [
                    ...
                    textField(
                        false, helper.linesection, 'Style_No', () {}, false, true),
                    Container(
              ...
              Row(
                ...
                children: [
                  Text('Measurement',style: TextStyle(fontWeight: FontWeight.bold),),
                  SizedBox(width: 5),
                  ElevatedButton(
                    style: ButtonStyle(
